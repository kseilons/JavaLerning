...
public class AnswerKeyProblem {
    public static void main(String args[]) throws IOException {
        // Чтение файла
        BufferedReader codedAnswers = new BufferedReader(new FileReader("C:/java/JavaLerning/6sem/lab8/KeyProblem/src/def/CodedAnswerKey"));
    ...
    public static String finalAnswers(String answers) {
        ...
        answers = answers.replace('e', 'b').replace('E', 'A').replace('f', 'c').replace('F', 'D');
