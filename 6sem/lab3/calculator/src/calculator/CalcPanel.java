...
public class CalcPanel extends JPanel implements ActionListener {
	...
	public CalcPanel()
	{
		...
		bequals.setBounds(150,300,50,50);
			
		bdiv.setBounds(150,250,50,50);
		bminus.setBounds(150, 100, 50, 50);
		bmultiple.setBounds(150,  150,  50, 50);
	...
	public void actionPerformed(ActionEvent e){
		...
		if(s.equals("="))
		{
			...
			case "*":
				...
				break;
			case "/":
				isZero = Double.parseDouble(num2) == 0;
				if (isZero) display.setText("error: division by zero");
				else display.setText("" +  Double.parseDouble(num1)/Double.parseDouble(num2));
			}
