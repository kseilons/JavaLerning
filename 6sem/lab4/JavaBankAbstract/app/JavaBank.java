...
public class JavaBank extends JFrame {
    ...
    private void createUserInterface() {
     ...
     // set up DisplayJButton
        ...
        accountTypes.addActionListener(x -> {
        	accountType = (AccountType) accountTypes.getSelectedItem();
        });
...
//        		displayJTextArea.setText(
//        			    "Bank Name      : " + myAccounts[noAccounts].getBankName() + 
//  					  "\nAccount Holder : " + myAccounts[noAccounts].getaccountname() + 
