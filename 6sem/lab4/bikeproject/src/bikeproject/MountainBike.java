...
public class MountainBike extends Bike implements MountainParts{
	...
	{
		return super.toString() + "This mountain bike is a " + this.type + " bike and has a " + this.suspension + " suspension and a frame size of " + this.frameSize + "inches. This bike is best for " + MountainBike.terrain;
